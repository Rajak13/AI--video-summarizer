...
const styles = {
  footer: "bg-gray-900 text-white py-6",
  container:
    "max-w-7xl mx-auto px-4 md:px-6 flex flex-row items-center justify-between",
  text: "text-sm text-gray-300 flex-1 text-center",
  socialContainer: "flex items-center space-x-4",
  socialLink: "text-white hover:text-gray-300 transition-colors",
  icon: "h-5 w-5",
  srOnly: "sr-only",
};
  ...
  return (
    <footer style={{
      ...
      <div style={{
        ...
        <p style={{ color: '#d1d5db', fontSize: '14px' }}>{text}</p>
